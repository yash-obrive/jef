...
export const blogData = {
  'earthing-lightning-protection-for-religious-structures': {
    ...
    breadcrumbTitle: "LIGHTNING PROTECTION FOR TEMPLES",
    date: "",
    imageUrl: "/BlogImg/blog-1.png",
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "earthing for temples and religious buildings, lightning risk management for heritage structures, LPS for places of worship, structural earthing design for temples",
  ...
  '3-key-steps-of-power-system-studies': {
    ...
    breadcrumbTitle: "POWER SYSTEM STUDY CONSULTANTS INDIA",
    date: "",
    imageUrl: "/BlogImg/blog-5.png",
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "lightning protection for life safety, why lightning safety matters, JEF lightning protection systems",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'electrical-safety-for-greenfield-projects': {
    ...
    breadcrumbTitle: "ELECTRICAL DESIGN CONSULTANT INDIA",
    date: "",
    imageUrl: "/BlogImg/blog-3.png",
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "electrical safety greenfield construction, greenfield project electrical engineering challenges, grounding systems greenfield sites, renewable energy integration greenfield projects",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'importance-of-electrical-safety-in-chemical-and-pharma-industries': {
    ...
    breadcrumbTitle: "ELECTRICAL SAFETY CHEMICAL INDUSTRY",
    date: "",
    imageUrl: "/BlogImg/blog-4.png",
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "electrical safety audit pharmaceutical industry, workplace electrical accident prevention chemical plants, explosion-proof electrical equipment pharma, lockout tagout LOTO electrical safety",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'prioritizing-lightning-safety-in-india': {
    ...
    breadcrumbTitle: "LIGHTNING PROTECTION INDIA",
    date: "",
    imageUrl: "/BlogImg/blog-2.png",
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "measurement simulation validation power systems, harmonic study and analysis, transient stability study, arc flash hazard analysis, load flow analysis, breaker coordination study, voltage drop study",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'reliability-in-renewable-energy-project': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "electrical grid compliance power studies, power system studies for utilities, grid efficiency power system studies",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'protecting-your-business-from-lightning': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "JEF Shield software, lightning risk assessment IEC 62305-2, automated LPS risk assessment report",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'ram-mandir-lightning-protection': {
    ...
    metaTags: {
      ...
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
      canonical: "https://www.jeftechno.com/blogs/ram-mandir-lightning-protection",
    },
    content: (
      <div className="flex flex-col gap-8 text-white/80 font-light leading-relaxed">
        <p>
  ...
  'automated-lightning-risk': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "business risk lightning strikes, commercial lightning protection systems, why businesses need LPS",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'electrical-fire': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "lightning arrestors for solar panels, surge protection devices solar plants, solar plant lightning damage causes",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'need-of-lightning-arrestor-for-solar-panels': {
    ...
    breadcrumbTitle: "SOLAR PANEL LIGHTNING PROTECTION",
    date: "",
    imageUrl: "/BlogImg/blog-12.png",
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "circuit breaker trip testing, warehouse electrical safety testing, fuse and breaker testing intervals",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'warehouse-electrical-protection-safety': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "miniature circuit breaker selection guide, MCB nuisance tripping prevention, MCB type for inrush current loads",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'selecting-the-right-mcb-type-for-electrical-safety': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "IS/IEC 62305-2 risk assessment, JEF Shield lightning risk software, lightning protection level 1 to 4",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'pq-services-economic-benefits-power-factor-harmonic-studies': {
    ...
    breadcrumbTitle: "power factor and harmonic study",
    date: "",
    imageUrl: "/BlogImg/blog-16.png",
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "economic benefits of power quality studies, reduce energy losses power factor, harmonic distortion cost reduction",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'type-a-vs-type-b-earthing': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "electrical safety in hospitals, hospital power quality fire risk, earthing for medical equipment, hospital electrical wiring standards",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'selection-of-low-voltage-spd-for-main-db': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "TT earthing vs TN-C-S earthing, concrete embedded foundation earth electrode, which earthing system is better",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'spd-selection-and-installation-myths-and-fact': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "surge protection device selection standards, SPD Iimp rating main distribution board, IEC standards SPD selection proof",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
...
b. Protection between Live conductor and neutral is RECOMMENDED to ensure equipment 
  ...
  'nbc-is-recommend-spd-for-protection': {
    ...
    breadcrumbTitle: "SPD protection standards India",
    date: "",
    imageUrl: "/BlogImg/blog-19.png",
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "SPD protection distance 10 meters rule, CT-1 vs CT-2 connection type SPD, SPD lead length installation",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'sources-of-switching-surges-installation-of-spds': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "surge protection device class I II III, transient overvoltage causes, SPD terminology IEC EN VDE",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'solutions-to-avoid-surges': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "CNC machine surge protection, EPROM corruption lightning surge, why SPD needed despite existing protection",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'surges-in-industrial-and-commercial-power-systems': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "radiated vs conducted surges, surge protection device functionality MCOV, why avoid electrical surges",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'dispelling-myths-lv-grounding-system': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "causes of electrical surges India, natural vs manufactured surges, IS IEC 62305 source S3",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'earthing-misconceptions': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "isolated earth electrode myth, global earthing concept IEC 61000-5-2, why not to separate electronic earth",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'application-note-wind-mills-lps-spd': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "IEC 61400-24 wind turbine lightning protection, lightning protection zones LPZ wind turbine, SPD for wind turbine electronics",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
    ...
    content: (
      <div className="flex flex-col gap-8 text-white/80 font-light leading-relaxed">
        ...
        <div>
          ...
          <ul className="list-disc pl-5 flex flex-col gap-3">
            <li><strong>LPZ O A:</strong> The area above the <a href="https://www.jeftechno.com/blogs/how-lps-work" className="underline">LPS installation</a> (electric &amp; magnetic field are maximum)</li>
        ...
        <p>
          ...
          <strong>SPDs:</strong> While radiated surges are limited by shielding technique, conducted surges are reduced below the withstanding level of equipment by using <a href="https://www.jeftechno.com/blogs/power-line-and-data-line-spd-protection" className="underline">SPDs for power, data, and communication lines</a>. Either Class I or Class I+II 3-phase SPD with 400/690 V compatible with minimum Iimp of 12.5 kA for TN-C system shall be employed in parallel at the main DB.
        </p>
        <p>Please let us know if you need further assistance or have any requirements: marketing@jeftechno.com</p>
      </div>
    )
  ...
  'importance-of-soil-resistance': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "Wenner four point method soil resistivity, touch and step potential soil resistivity, CDEGS multilayer soil model",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'lightning-phenomenon-reasons-solutions': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "how does lightning form, intra-cloud vs cloud-to-ground lightning, why lightning is unpredictable",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'role-of-grounding-in-electrical-safety': {
    ...
    breadcrumbTitle: "GROUNDING IN ELECTRICAL SAFETY CONSULTANT",
    date: "",
    imageUrl: "/BlogImg/blog-30.png",
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "earth pit resistance vs earth loop impedance, grounding compound ground enhancement material, IEEE 142 backfill compound",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
    ...
    content: (
      <div className="flex flex-col gap-8 text-white/80 font-light leading-relaxed">
        ...
        <p>
          <a href="https://www.jeftechno.com/blogs/earthing-misconceptions" className="underline">Another myth revolves around the concept of Global Grounding.</a> As per the concept of "Global earthing", electrical earthing, electronic earthing, instrumentation earthing, communication earthing, structure earthing and lightning protection system earthing should be interconnected below the ground. This is recommended in IS 3043, IS/IEC 62305, IEC 61000-5-2, and IEEE 142 Standards.
        </p>
  ...
  'necessity-maintenance-free-earthing': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "maintenance free earthing, earthing maintenance, conventional earthing problems, maintenance free grounding, earth pit maintenance, soil resistivity, conductive concrete backfill, ground enhancement material",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
    ...
    content: (
      <div className="flex flex-col gap-8 text-white/80 font-light leading-relaxed">
        ...
        <p>
          India being a tropical country, where close to 9 months is dry season, a single <a href="https://www.jeftechno.com/blogs/interconnection-of-earth-pits" className="underline">earth pit</a> needs around 4000 liters of water just to raise moisture content to 5% — which is impossible to provide with so much scarcity. The salt provided also dissolves over time due to rain (in many places, within 2-3 years), causing resistance to rise and the earthing to become useless.
        </p>
        <div>
  ...
  'power-line-and-data-line-spd-protection': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "power line SPD, data line SPD, surge protection device, SPD selection, voltage protection level Up, nominal discharge current, maximum discharge current, IEC 61643-11, IEC 61643-21",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
    ...
    content: (
      <div className="flex flex-col gap-8 text-white/80 font-light leading-relaxed">
        ...
        <p>
          Though selection of SPDs is important, installation is more crucial because <a href="https://www.jeftechno.com/blogs/spd-selection-and-installation-myths-and-fact" className="underline">SPD installation</a> is different from Fuse/MCB installation.
        </p>
        <p>Please let us know if you need further assistance or have any requirements: marketing@jeftechno.com</p>
      </div>
    )
  ...
  'lightning-risk-indian-industries': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "lightning risk assessment India, industrial lightning protection, LPS, surge protection devices, IS IEC 62305, lightning protection zones, lightning risk assessment software, LPL",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
    ...
    content: (
      <div className="flex flex-col gap-8 text-white/80 font-light leading-relaxed">
        ...
        <p>
          <a href="https://www.jeftechno.com/blogs/automated-lightning-risk" className="underline">JEF has created Risk Assessment Software</a> based on IS/IEC 62305-2, validated using the four worked-out examples provided in the standard. The software includes thunderstorm data for around 158 places across India from NBC 2016.
        </p>
        <p>
          If the calculated risk is higher than the acceptable level, a cost-effective preventive strategy can be implemented. If building steel is used as part of the <a href="https://www.jeftechno.com/blogs/how-lps-work" className="underline">Lightning Protection System</a>, you not only have the most economical solution but also the most reliable system.
        </p>
        <div>
  ...
  'electrical-safety-retail-industry': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "retail electrical safety, electrical safety audit retail, retail fire safety, electrical hazards in retail stores, electrical compliance retail, NBC 2016 fire safety",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'interconnection-of-earth-pits': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "earth pit installation, earthing pit, grounding grid, transformer neutral earthing, lightning earthing, electronic equipment earthing, equipotential bonding, IS 3043",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
    ...
    content: (
      <div className="flex flex-col gap-8 text-white/80 font-light leading-relaxed">
        ...
        <div>
          ...
          <p>
            IEC 62305-3 and BS7430 have clearly recommended that the <a href="https://www.jeftechno.com/blogs/need-for-lps" className="underline">lightning protection system</a> earth should solidly bond to the general earth grid to avoid dangerous potential differences between two unconnected earth systems in case of a lightning current.
          </p>
        </div>
        <div>
          ...
          <p className="mt-4">
            IEC 61000-5-2 (Clause 5.3.1) does not encourage the use of independent "ISOLATED" <a href="https://www.jeftechno.com/blogs/type-a-vs-type-b-earthing" className="underline">earth electrodes</a> for computer and electrical systems. IEEE 1100-2003 (Clause 4.8.5.1) clearly mentions that electronic equipment should not use isolated grounds and details the benefits of connecting dedicated electronic earthing to the general earth grid.
          </p>
        </div>
        <p>
  ...
  'soil-treatment-for-good-earthing': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "soil treatment earthing, ground enhancement material, conductive concrete, backfill compound, earth resistance reduction, soil resistivity, maintenance free earthing",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'ways-to-protect-cnc-machine': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "CNC machine protection, CNC surge protection, industrial surge protection, transient overvoltage, switching surge, lightning surge, EMI RFI, PLC protection, MMI protection, IEC 61643-11",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'soil-resistivity-earthing-design-safety-reliability': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno",
      description: "",
      keywords: "soil resistivity measurement, earthing design, Wenner four point method, touch voltage, step voltage, multilayer soil model, IEEE 80, CDEGS, grounding design",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'application-note-wind-mills-lps-spd-2': {
    ...
    content: (
      <div className="flex flex-col gap-8 text-white/80 font-light leading-relaxed">
        ...
        <p>
          <strong>SPDs:</strong> Conducted surges are reduced below the withstanding level of equipment by using <a href="https://www.jeftechno.com/blogs/power-line-and-data-line-spd-protection" className="underline">SPDs for power, data, and communication lines</a>. Either Class I or Class I+II 3-phase SPD with 400/690 V compatible with minimum Iimp of 12.5 kA for TN-C system shall be employed in parallel at the main DB.
        </p>
        <p>Please let us know if you need further assistance or have any requirements: marketing@jeftechno.com</p>
      </div>
    )
  ...
  'how-lps-work': {
    ...
    metaTags: {
      ...
      description: "",
      keywords: "lightning protection system, lightning rods, lightning protection grounding, lightning surge protection, SPD protection, lightning protection installation",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'emi-overhead-power-lines-buried-pipelines': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno (appears sitewide; verify page source)",
      description: "",
      keywords: "AC interference pipeline, overhead power line pipeline interference, AC corrosion pipeline, electromagnetic interference pipeline, cathodic protection interference, pipeline grounding",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'importance-of-fire-safety': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno (appears sitewide; verify page source)",
      description: "",
      keywords: "fire safety, electrical fire safety, fire risk assessment, NBC fire safety, NBC 2016 Part 4, fire protection systems, building fire safety audit",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'power-quality-events-parameters': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno (appears sitewide; verify page source)",
      description: "",
      keywords: "power quality, power quality parameters, voltage sag, voltage swell, harmonics, transients, voltage unbalance, flicker, IEC 61000-4-30",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'need-for-lps': {
    ...
    metaTags: {
      title: "Industrial Electrical Engineering Services | JEF Techno (appears sitewide; verify page source)",
      description: "",
      keywords: "LPS adequacy study, lightning risk assessment, IS IEC 62305, lightning protection audit, LPL 1 to 4, coordinated SPD protection, earthing and bonding",
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
  ...
  'hidden-electrical-risks-hospitals-should-know': {
    ...
    metaTags: {
      ...
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
      canonical: "https://www.jeftechno.com/blogs/hidden-electrical-risks-hospitals-should-know",
    },
    content: (
      <div className="flex flex-col gap-8 text-white/80 font-light leading-relaxed">
        ...
        <div>
          ...
          <p className="mt-4">
            For hospitals — often taller structures, frequently housing sensitive diagnostic and life-support electronics — an <a href="https://www.jeftechno.com/blogs/how-lps-work-2" className="underline">LPS adequacy audit</a> against IS/IEC 62305 isn't a formality. It's the difference between a lightning event being a non-event and it being a facility-wide power incident during a medical emergency.
          </p>
        </div>
  ...
  'hospital-electrical-fire-safety-audit-deliverables': {
    ...
    metaTags: {
      ...
      robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1",
      canonical: "https://www.jeftechno.com/blogs/hospital-electrical-fire-safety-audit-deliverables",
    },
    content: (
      <div className="flex flex-col gap-8 text-white/80 font-light leading-relaxed">
        ...
        <p>
          A properly run <a href="https://www.jeftechno.com/blogs/hidden-electrical-risks-hospitals-should-know" className="underline">electrical and fire safety audit for a hospital</a> isn't a document. It's a structured, standards-mapped diagnosis of exactly where infrastructure reliability, patient safety, and regulatory compliance stand today — followed by a corrective roadmap that tells you, in order of urgency, what to fix and why. In a facility where a power interruption can mean a ventilator, a dialysis session, or a surgery in progress, that roadmap is the actual deliverable. The PDF is just how it's handed to you.
        </p>
        <p>
        ...
        <div>
          ...
          <p>
            Panels, busbars, and cable terminations are scanned under normal operating load to surface hotspots invisible to a visual inspection — the same failure mode covered in our companion piece on <a href="https://www.jeftechno.com/blogs/hidden-electrical-risks-hospitals-should-know" className="underline">hidden electrical risks in hospitals</a>. The audit report should show the actual thermal images alongside the temperature differentials flagged, not just a pass/fail note.
          </p>
        </div>
