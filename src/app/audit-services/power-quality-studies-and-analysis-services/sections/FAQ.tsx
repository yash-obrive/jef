...
const faqData = [
  {
    id: 1,
    question:
      "Why do Power Quality Studies help reduce equipment failures and operational costs?",
    answer: `A Power Quality Study identifies potential issues that cause equipment failures, tripping, and inefficiencies. By preventing equipment damage and minimizing downtime, these studies directly reduce operational costs.`,
  },
  {
    id: 2,
    question:
      "What are the key components of a Power Quality Study?",
    answer: `The study involves a systematic assessment of voltage quality (sags, swells, harmonics), current quality (distortions), frequency stability, and transient analysis.`,
  },
];
